  ...
  <div style="max-width:600px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08)">
    ...
    <div style="background:#f1f5f9;padding:16px 32px;text-align:center">
      <p style="color:#94a3b8;font-size:12px;margin:0">
        ...
        <a href="http://localhost:8000" style="color:#3b82f6">A2A Registry</a>
      </p>
    </div>
  </div>
</body>
...
async def handle_message(request: Request):
    ...
    candidates = cand_data.get("candidates", []) if cand_data else []
    role       = cand_data.get("job_analysis", {}).get("role", "Software Engineer") if cand_data else "Software Engineer"
